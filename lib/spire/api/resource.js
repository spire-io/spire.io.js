...
Resource.prototype.authorization = function () {
...
Resource.prototye.schema = function () {
  return this.spire.schema[this.resourceName];
};

Resource.prototype.mediaType = function () {
  return this.schema.mediaType;
};
