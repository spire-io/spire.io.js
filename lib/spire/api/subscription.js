...
//
// The first is to call `subscription.retrieveMessages` directly.  This is the
// most general method, and supports a number of options.
//
// There are convenience methods `subscription.poll` and `subscription.longPoll`
// which wrap `retrieveMessages`.  The only difference is that `subscription.poll` has a timeout of 0, so
...
// ### Subscription.prototype.retrieveMessages
